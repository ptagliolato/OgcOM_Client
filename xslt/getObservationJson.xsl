...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="om:OM_Observation">
        ...
        "procedure": "<xsl:value-of select="om:procedure/@xlink:href"/>",
        "observedProperty": "<xsl:value-of select="om:observedProperty/@xlink:href"/>",
        "featureOfInterest": {
        "uri": "<xsl:value-of select="om:featureOfInterest/@xlink:href"/>",
        "title": "<xsl:value-of select="om:featureOfInterest/@xlink:title"/>"
        },
        "result": "<xsl:value-of select="om:result/@xlink:href"/>"
        }
